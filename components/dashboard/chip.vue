...
class="inline-flex m-4 items-center justify-center rounded-full bg-emerald-100 px-2.5 py-0.5 text-emerald-700 h-8"
>
<svg
...
<p class="whitespace-nowrap text-sm">Failure</p>
</span>
</template>