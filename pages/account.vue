...
<template>
  ...
  <div v-if="!storageMessage" class="flex flex-col w-full align-middle justify-center">
    <div
    class="rounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8 mb-20 mx-12"
    role="alert"
  >
    ...
    <p class="mt-4 text-gray-500">
      We just want you to remind you that your generated videos are stored for <span class="text-green-500">5 days</span>. After that, to reduce our digital footprint, they will be deleted. If you want to keep them, please download them.
    </p>
